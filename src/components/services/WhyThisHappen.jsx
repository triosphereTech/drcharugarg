      ...
      <div className="relative mx-auto max-w-7xl px-3 pt-10 md:px-5 md:pt-20">
        <div className="grid gap-10 lg:grid-cols-[0.95fr_1fr] lg:items-center lg:gap-16">
          ...
          <div className="relative">
            ...
            {/* Floating Card */}
            <div className="absolute bottom-5 left-5 max-w-[280px] rounded-[28px] border border-white/70 bg-white/92 p-5 shadow-[0_15px_40px_rgba(0,0,0,0.08)] backdrop-blur-xl md:p-6">
              ...
              <button className="group mt-5 flex items-center gap-2 text-sm font-medium text-[#058FD2]">
                Learn More
                <ArrowUpRight
                  size={16}
                  className="transition-transform duration-300 group-hover:-translate-y-0.5 group-hover:translate-x-0.5"
