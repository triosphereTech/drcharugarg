            ...
            >
              ...
              <div className="relative overflow-hidden rounded-[30px]">
                ...
                >
                  ...
                  <p className="pt-2 pr-1 text-xs md:text-sm font-semibold uppercase tracking-[2px] text-primary-dark/50">
                    Years <br />
                    Experience
                  </p>
                </motion.div>
            ...
            >
              <div>
                ...
                <div className="max-w-[620px] pt-6">
                  <h2 className="text-3xl font-semibold leading-[110%] text-primary-dark md:text-5xl">
                    Dr. Charu Garg
                ...
                {/* SHORT DESCRIPTION */}
                <div className="max-w-[720px] pt-5 md:pt-7">
                  <p className="text-sm font-medium leading-[190%] text-primary-dark/65 md:text-[17px]">
                    Dr. Garg is a qualified dermatologist with over five years
                    of clinical experience in managing disorders of the skin,
                    hair, and nails. She completed her MD in Dermatology from
                    Government Medical College, Surat, and pursued a fellowship
                    in Advanced Clinical Dermatology and Lasers from Mumbai. She
                    is committed to delivering comprehensive, patient-focused
                    dermatology care, combining in-clinic expertise with
                    seamless digital follow-up support to ensure continuity of
                    care and long-term treatment outcomes.
                  </p>
                ...
                <div className="flex flex-wrap gap-3 pt-8">
                  <Link
                    href="/about"
                    className="py-3 px-3 md:px-6 2xl:px-8 rounded-full bg-primary-accent text-[#ffffff] transition-all text-md active:scale-95 2xl:text-xl font-semibold flex items-center gap-2 shadow-sm shadow-inner"
                  >
                    Read more
                    <HiArrowUpRight className="text-xs md:text-lg 2xl:text-xl" />
                  </Link>
                  <Link
